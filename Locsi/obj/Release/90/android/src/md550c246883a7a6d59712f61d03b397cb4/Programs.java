...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Locsi.Programs, Locsi", Programs.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == Programs.class)
			mono.android.TypeManager.Activate ("Locsi.Programs, Locsi", "", this, new java.lang.Object[] {  });
	}
